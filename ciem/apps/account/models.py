...
class ipaq(models.Model):
	...
	p4b_trabajo = models.BooleanField(default=True)
	...
	p6b_trabajo = models.BooleanField(default=True)
	...
	p8b_transporte = models.BooleanField(default=True)
	...
	p10b_transporte =models.BooleanField(default=True)
	...
	p12b_transporte = models.BooleanField(default=True)
	...
	p14b_hogar =models.BooleanField(default=True)
	...
	p16b_hogar = models.BooleanField(default=True)
	...
	p18b_hogar = models.BooleanField(default=True)
	...
	p20b_recreacion = models.BooleanField(default=True)
	...
	p22b_recreacion = models.BooleanField(default=True)
	...
	p24b_recreacion = models.BooleanField(default=True)

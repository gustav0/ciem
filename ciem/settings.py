...
DATABASES = {
    'default': {
        ...
        'USER': 'ciem',                      # Not used with sqlite3.
        'PASSWORD': 'ciem1234',                  # Not used with sqlite3.
...
USE_TZ = False
#modificado para que se puedan publicar los articulos.
...
SECRET_KEY = 'vy!sn-h%nm_cp-k179qd6ex+$8ne0&amp;8-qfjd6p-9+nn9!w-+m+'
